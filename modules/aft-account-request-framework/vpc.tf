...
# VPC Subnets
#########################################
#data "aws_subnet" "aft_vpc_private_subnet_01" {
#  count = var.aft_create_vpc ? 0 : 1
#  id    = var.aft_vpc_config.subnet_ids[0]
#}
...
#data "aws_subnet" "aft_vpc_private_subnet_02" {
#  count = var.aft_create_vpc ? 0 : 1
#  id    = var.aft_vpc_config.subnet_ids[1]
#}
...
resource "aws_vpc_endpoint" "s3" {
  ...
  route_table_ids = [
    ...
    aws_route_table.aft_vpc_public_subnet_01[0].id
  ]
}
